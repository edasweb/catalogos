...
brand_name = None
sheet_2.append(["Manufacturer","Supplier","Price","Purchase","%","VAT","Reference","Name","EAN13","Category","Description","Meta title","Tags","Keywords","Rewrite"])
...
wb.save("tien_all_stars_import_catalogue_new_with_gama.xlsx")
